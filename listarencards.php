...
<body>
  ...
  <button type="sumit"><a href="listarencards.php">Listar cards</a></button>
  ...
  <section>
    <div class="container">
      <div class="row">
        ...
        mysqli_select_db($conexion, "tp7_backend");
        ...
        while ($reg = mysqli_fetch_array($datos)) {?>
          <div class="card col-sm-12 col-md-6 col-lg-3">
            <img class="card-img-top" src="data:image/jpg;base64, <?php echo base64_encode($reg['imagen'])?>" alt="" width="70px" height="100px")>
